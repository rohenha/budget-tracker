          ...
          <DialogContent>
            ...
            <div className="flex flex-col gap-4">
              <Field>
                ...
                <FieldContent>
                  <Input name="label" id="label" placeholder="Alimentation" aria-invalid={!!errors.label} />
                    ...
                    {filtered.map((name) => {
                      ...
                      return (
                        <button
                          key={name}
                          type="button"
                          onClick={() => { setIcon(name); setSearch('') }}
                          className={cn(
              ...
              <Field>
                ...
                <FieldContent>
                  <Input type="color" name="color" defaultValue="#6366f1" className="h-7 w-14 p-0.5" />
